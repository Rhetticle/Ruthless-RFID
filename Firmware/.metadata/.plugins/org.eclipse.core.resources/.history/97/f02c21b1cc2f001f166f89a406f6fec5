...
static const char* FILEDATA_SCREEN[5] = {".", "SIZE: 128KiB", "UID: ", "CONTENTS: ", "EXIT"};
static const uint8_t FILEDATA_DATLOC[5][2] = {{0,MID_COL-12}, {2,START_COL},{4,START_COL},{6,START_COL}, {2, END_COL - 24}};
static const uint8_t FILEDATA_SEL[1][2] = {{2,END_COL - 36}};
/**
 * Screens
 *
 * */
