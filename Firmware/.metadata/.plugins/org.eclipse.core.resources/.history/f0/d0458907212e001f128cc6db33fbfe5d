...
static const char* SHOW_FILESSCREEN[7] = {"FILES", "* ", "* ", "* ", "* ", "* ", "* "};
static const uint8_t SHOW_DATLOC[7][2] = {{0,0},{2,START_COL},{4,START_COL},{6,START_COL},{2,MID_COL+15},{4,MID_COL+15},{6,MID_COL+15}};
